(function ( $ ) {
    ...
    function GMapContext(domElement, options) {
        ...
        var _marker = new google.maps.Marker({
            position: new google.maps.LatLng(28.637099, 77.36084988298944),
            map: _map,
            title: "Drag Me",
    ...
    function setupInputListenersInput(inputBinding, gmapContext) {
        if (inputBinding) {
            ...
            var southWest = new google.maps.LatLng(28.390882, 77.342512);
            var northEast = new google.maps.LatLng( 28.641872, 77.464735 );
            ...
            if (inputBinding.locationNameInput && gmapContext.settings.enableAutocomplete) {
                gmapContext.autocomplete = new google.maps.places.Autocomplete(inputBinding.locationNameInput.get(0),autoopt);
