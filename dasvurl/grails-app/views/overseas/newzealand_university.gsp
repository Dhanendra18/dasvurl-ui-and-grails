...
<header class="box-shadow university-bg-img head">
	...
	<div class="content">
		<div class="container">
			<h1 class="animated fadeInDown fontbold">New Zealand Universities<br>And <br>Colleges</h1>
			<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 heading">
				<h1>About <span> New Zealand</span></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				<h2>Advantages Of Studying In France</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				<p class="fontSize16" >France has enabling and enlightened education process with a reputation for brilliance and provides</p>
			</div>
		</div>
	</div>
</div>
