...
<div class="navbar-wrapper" style="margin-top: 14px;">
	<div class="container custom-nav-container">
		<div class="row">
			<div class="col-lg-2 custom-nav-logo">
				<ul class="nav navbar-nav navbar-right">
					<a class="navbar-brand" href="#"><img src="images/logo/DAS_VURL.png" alt="logo" height="180px" width="200px"/></a>
				</ul>
			</div>
			<div class="col-lg-10" style="padding: 0 12px">
				<nav class="navbar navbar-inverse navbar-static-top" style="border-radius: 1px; margin-top: 72px; min-height: 90px;">
							...
							<ul class="nav navbar-nav">
								<li class="active nav-cust">
									<a class="page-scroll" href="#" style="padding: 0">
										...
										<i class="nav-cust-i2">
											<i class="nav-cust-content">ABOUT US</i>
								...
								<li class="active nav-cust">
									<a class="page-scroll" href="#id_contactUs" style="padding: 0">
										...
										<i class="nav-cust-i2">
											<i class="nav-cust-content">CONTACT US</i>
											<!--<i class="nav-cust-content-sub">WHO ARE WE</i>-->
										</i>
										<!--<i  style="font-style: normal; line-height: inherit; height: 20px;">OVERSEAS EDUCATION</i>-->
									</a>
								...
								<li class="active nav-cust">
									<a class="register_now" style="padding: 0">
										...
										<i class="nav-cust-i2">
											<i class="nav-cust-content">REGISTER NOW</i>
											<!--<i class="nav-cust-content-sub">WHO ARE WE</i>-->
										</i>
									</a>
								</li>
...
<!--/first nav-->
<!--Second nav-->
<nav class="navbar navbar-black navbar-fixed-top navme" role="navigation" style="display: none">
	<div class="container">
		<div class="navbar-header">
			<p href=".fstpage" class="page-scroll baseHeader fontSize20" style="margin-top: 10px;">Das VURL</p>
		</div>
		<div>
...
<section class="sec2b scrollbtn" id="id_ourServices">
	<div class="container">
		...
		<!--  old codes -->
		<h3 class="statepg2" align="center">OUR SERVICES</h3>
		<div class="row content_1stpg" style="color: #fff">
			<div class="col-md-6">
				<div class="row rowbase">
					<div class="col-xs-7"><h4 class="text-underline fontextra fontSize24">OVERSEAS</h4></div>
				</div>
				<div class="row rowbase">
	...
	<div class="container">
		<div class="row" style="margin-top: 60px;">
			...
			<div class="col-md-6">
				...
				<div class="row">
					<img alt="location" src="images/contactus_locationl.png" style="float: left; margin-bottom: 20px; margin-left: 20px;"><p class="fontregular fontSize18" style=" margin-left: 70px; margin-bottom: 20px;">SD-142 Shastri nagar, Ghaziabad, Uttar Pradesh, India- 201001</p>
...
<script type="application/javascript">
	...
	$(document).ready(function(){
		...
		setInterval(function(){
			...
			setTimeout(function(){
				$("#id_aboutUs").addClass("sec1-backImage1");
			},5000);
			setTimeout(function(){
		...
		var countryOptions = '<option value="" disabled selected>Option 1</option>';
		$("#countryOption1").html(getCountryOptions(countryOptions));
		countryOptions = '<option value="" disabled selected>Option 2</option>';
